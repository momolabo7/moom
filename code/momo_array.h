...
#define List_Remove(l,i)   ((i < (l)->count) ? (Memory_Copy((l)->e+i, (l)->e+i+1, sizeof((l)->e[0])*((l)->count--)-i)), 1 : 0)
...
#define SList_Remove(l,i)   ((i < (l)->count) ? (Memory_Copy((l)->e+i, (l)->e+i+1, sizeof((l)->e[0])*((l)->count--)-i)), 1 : 0)
